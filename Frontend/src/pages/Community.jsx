    ...
    <div className="p-8 max-w-6xl mx-auto min-h-screen font-rubik">
      ...
      >
        <Modal.Header className="dark:border-gray-700">
          <span className="dark:text-white text-lg font-semibold">{formData.isEditing ? 'Edit Post' : 'Create Post'}</span>
        </Modal.Header>
      ...
      >
        <Modal.Header className="dark:border-gray-700">
          <span className="dark:text-white text-lg font-semibold">Add Comment</span>
        </Modal.Header>
        <Modal.Body className="dark:bg-gray-800">
          <Textarea
            value={commentText}
